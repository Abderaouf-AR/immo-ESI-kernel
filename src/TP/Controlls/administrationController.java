...
public class administrationController extends Parent {
    ...
    public void initialize(){
        window w = new window();
        this.est.setText(this.est.getText()+" "+w.getAgence().getNb_bien());
        this.mesg.setText(this.mesg.getText()+" "+w.getAgence().getNb_notif());
        this.own.setText(this.own.getText()+" "+w.getAgence().getNb_prop());
    }
